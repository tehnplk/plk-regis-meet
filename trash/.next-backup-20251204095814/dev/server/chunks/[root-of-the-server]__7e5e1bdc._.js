...
async function POST(request) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSession"])(authOptions);
    if (!session) {
    ...
    try {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Invalid JSON', {
            status: 400
        });
    }
    if (!body || typeof body !== 'object') {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Invalid payload', {
            status: 400
        });
    }
    const { title, date, endDate, time, location, capacity, description, status } = body;
    const numericCapacity = typeof capacity === 'string' ? Number(capacity) : capacity;
    if (!title || !date || !time || !location || numericCapacity == null || Number.isNaN(numericCapacity) || !description) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e5e1bdc._.js.map